"""
Script 2: Animación con refugio como franja vertical central
...
def crear_animacion_franja_vertical():
    """
    Crea animación con refugio como franja vertical central.
    """
    print("\n" + "="*70)
    print("GENERANDO ANIMACIÓN: REFUGIO FRANJA VERTICAL")
    print("="*70)
    ...
    # Generar refugio como franja vertical central
    print("\n2. Generando refugio como franja vertical...")
    gen = RefugeGenerator(L=L, nx=nx, ny=ny)

    # Franja vertical de ancho 3.0 centrada
    strip_width = 3.0
    ...
    print(f"   ✓ Franja vertical creada (ancho: {strip_width})")
    ...
    ax_spatial.set_title('Refugio Franja Vertical - Spawn Aleatorio\nt = 0.00 s', fontsize=14, fontweight='bold')
    ...
    def update(frame):
        ...
        # Actualizar título
        ax_spatial.set_title(f'Refugio Franja Vertical - Spawn Aleatorio\nt = {times[frame]:.2f} s',
    ...
    output_path = output_dir / '2_refugio_franja_vertical.gif'
...
if __name__ == "__main__":
    crear_animacion_franja_vertical()
